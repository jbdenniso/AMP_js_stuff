...
/////
//function showPrimeImage(src, path) {
//	path = path || 'images/'; // default path here
	//var imgStr = '<img src="' + path + src + '" alt = "">';
  //  document.write(imgStr); //document.close();
    //imgStr.style.display = 'Block';
    	
//function showPrimeImage(src) {
//path = path || 'images/'; // default path here
//var imgStr = '<img src="' + path + src + '" alt = "">';
//document.getElementById('probeText').innerHTML = src;
//};

// NEW FUNCTION FOR HANDLING IMAGES INSTEAD OF WORDS (AK)
// PRIMES
function showPrimeImage(src) {
	path = 'images/primes/'; // default path here
	var this_image = '<img src="' + path + src + '" alt = "" height = "400" width = 400>';
	document.getElementById('probeText').innerHTML = this_image;
};

// TARGETS
function showTargetImage(src) {
	path = 'images/targets/'; // default path here
	var that_image = '<img src="' + path + src + '" alt = "" height = "400" width = 400>';
	document.getElementById('probeText').innerHTML = that_image;
};

//BLANK
function showBlankImage(src) {
	path = 'images/blank'; // default path here
	var that_image = '<img src="' + path + src + '" alt = "" height = "400" width = 400>';
	document.getElementById('probeText').innerHTML = that_image;
};
...
function showStaticImage(src) {
	path = 'images/static/'; // default path here
	var that_image = '<img src="' + path + src + '" alt = "" height = "400" width = 400>';
	document.getElementById('probeText').innerHTML = that_image;
};
...
/* 
GTD1: ObjectLeft-Version1
GTD2: ObjectLeft-Version2
GTD3: ObjectRight-Version1
GTD4: ObjectRight-Version2
*/
